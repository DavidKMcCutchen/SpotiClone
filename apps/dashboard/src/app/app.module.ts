...
@NgModule({
  declarations: [AppComponent, HomeComponent,  NavBarComponent, SearchComponent, SearchModalComponent, SearchArtistItemComponent, SearchTrackItemComponent, ArtistComponent, ArtistAlbumsComponent, ArtistTopTrackComponent, NewReleaseItemComponent, AlbumComponent],
  imports: [
    BrowserModule,
    HttpClientModule,
    RoutingModule,
